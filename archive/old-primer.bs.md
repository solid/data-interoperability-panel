...
<figure>
  ...
  <figcaption>Alice's Access Consent Registry</figcaption>
</figure>
...
<figure>
  <pre class=include-code>
  path: snippets/auth.alice.example/eac2c39c-c8b3-4880-8b9f-a3e12f7f6372.ttl
  highlight: turtle
  show: 4-100
  </pre>
  <figcaption>Alice's Access Consent for Projectron</figcaption>
</figure>

<figure>
  <pre class=include-code>
  path: snippets/auth.alice.example/75a2ef88-d4d4-4f05-af1e-c2a63af08cab.ttl
  highlight: turtle
  show: 4-100
  </pre>
  <figcaption>Alice's Access Consent for PerformChart</figcaption>
</figure>
...
<figure>
  <pre class=include-code>
  path: snippets/auth.alice.example/5dc3c14e-7830-475f-b8e3-4748d6c0bccb.ttl
  highlight: turtle
  show: 5-100
  </pre>
  <figcaption>Alice's social agent registration for ACME</figcaption>
</figure>

<figure>
  <pre class=include-code>
  path: snippets/auth.alice.example/b1f69979-dd47-4709-b2ed-a7119f29b135.ttl
  highlight: turtle
  show: 5-100
  </pre>
  <figcaption>Alice's social agent registration for Omni</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Alice's access grant from ACME</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Alice's access grant from Omni</figcaption>
</figure>
